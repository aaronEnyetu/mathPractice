...
class Calculator extends React.Component {
  ...
  applyPercentage(digit) {
    ...
    if (displayValue.includes('.')) {
      noOfDecimalPlaces += displayValue.substring(displayValue.indexOf('.') + 1).length;
    }
  ...
  render() {
    return (
      <div id="calculator" className="calculator">
        <div id="output">
          <div id="output-text" style={{ fontSize: this.getFontSize() }}>
            {this.state.displayValue}
          </div>
        </div>
        <div id="buttons">
          <div id="layer1">
            <CalculatorBtn value={'AC'} onClick={() => this.setState(this.initialState)} />
          ...
          <div id="layer5">
            <CalculatorBtn value={'0'} id={'zero-btn'} onClick={() => this.enterDigit('0')} />
            <CalculatorBtn value={'.'} onClick={() => this.addFloatingPoint()} />
            <CalculatorBtn
              value={'='}
              class={'operator-btn'}
